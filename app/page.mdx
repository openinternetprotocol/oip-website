...
The OIP spec and related documentation are in active development and subject to change. If you are a developer interested in building applications on OIP, please reach out to the core development team.
</Callout>
